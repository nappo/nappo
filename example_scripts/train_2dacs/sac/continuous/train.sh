...
CUDA_VISIBLE_DEVICES=$DEVICES python example_scripts/train_2dacs/sac/continuous/train.py  \
...
--frame-skip $FRAME_SKIP --frame-stack $FRAME_STACK --num-workers $NUM_WORKERS --env-id $ENV_ID
