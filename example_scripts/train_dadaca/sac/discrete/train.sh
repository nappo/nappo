...
CUDA_VISIBLE_DEVICES=$DEVICES python example_scripts/train_dadaca/sac/discrete/train.py  \
...
--target-update-interval $TARGET_UPDATE_INTERVAL --num-col-workers $NUM_CWORKERS \
