...
def main():
    ...
    create_collection_workers = CWorkerSet.worker_set_factory(
        ...
        num_workers=args.num_col_workers,
        worker_remote_config={"num_gpus": 0.25})
    grad_workers = GWorkerSet(
        ...
        num_workers=args.num_grad_workers,
        worker_remote_config={"num_gpus": 0.25})
...
def get_args():
    ...
    parser.add_argument(
        '--num-col-workers', type=int, default=1, help='how many agent workers to use (default: 1)')
    parser.add_argument(
        '--num-grad-workers', type=int, default=1, help='how many agent workers to use (default: 1)')
    parser.add_argument(
