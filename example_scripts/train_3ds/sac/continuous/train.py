...
from example_environments import make_real_robot_train_env, make_real_robot_test_env, her_function_robot
...
def main():
    ...
    cgu_workers = CGUWorkerSet(
        create_storage_instance=create_buffer, num_workers=args.num_workers,
        ...
        worker_remote_config={"num_cpus": args.num_env_processes, "num_gpus": 0.5,
        "object_store_memory": 5 * 1024 ** 3, "memory": 10 * 1024 ** 3})

    # 7. Define learner
    learner = Learner(cgu_workers, target_steps=args.num_env_steps, log_dir=args.log_dir)
